...
const SideCard = ({ title, duration, image, views, date, channelName }) => {
    ...
    return (
        <button className='mb-5 cursor-pointer grid grid-cols-5 gap-2 text-left' onClick={() => navigate('/view')}>
            {/* Image  */}
            ...
            <div className='col-span-3'>
                {/* Title  */}
                <div className=''>
                    <p className='text-black text-sm leading-4 line-clamp-2 font-medium '>
                        {title}
                    </p>
                    ...
                    {/* Views  */}
                    <div className='flex items-center text-xs space-x-2 truncate\'>
                        <p>{views} views</p>
